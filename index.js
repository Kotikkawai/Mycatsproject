...
//Background
const bg = new Image();
bg.src = 'foto/background.png';

//Snake
const snakeImg = new Image();
snakeImg.src = 'foto/snake.png';
...
function drawGame() {
  ...
  for(let i = 0; i < snakeSpawn.length; i++) {
    ...
    ctx.fillStyle = i === 0 ? 'transparent' : "#789423";

    //@TODO need modify this line because now sanke head push up transparent head box
